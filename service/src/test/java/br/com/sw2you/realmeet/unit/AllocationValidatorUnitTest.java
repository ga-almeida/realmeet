...
class AllocationValidatorUnitTest extends BaseUnitTest {
    ...
    void testValidateWhenAllocationEndAtInTheFuture() {
        ...
        assertEquals(new ValidationError(ALLOCATION_END_AT, ALLOCATION_END_AT + IN_THE_PAST), exception.getValidationErrors().getError(0));
    }
    ...
    void testValidateWhenAllocationDateOrdering() {
        ...
        assertEquals(new ValidationError(ALLOCATION_DATES, ALLOCATION_DATES + INCONSISTENT), exception.getValidationErrors().getError(1));
    }
    ...
    void testValidateWhenAllocationDuration() {
        ...
        assertEquals(new ValidationError(ALLOCATION_DATES, ALLOCATION_DATES + EXCEEDS_DURATION), exception.getValidationErrors().getError(0));
    }
}
